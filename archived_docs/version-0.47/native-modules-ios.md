---
id: version-0.47-native-modules-ios
title: 原生模块
...
更多给 JavaScript 发送事件的例子请看[`RCTLocationObserver`](https://github.com/facebook/react-native/blob/master/Libraries/Geolocation/RCTLocationObserver.m)。
