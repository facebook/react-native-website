...
As part of this release, the React, React Native, Metro, Yoga and React Native Website repositories are moving from the `facebook` GitHub organization to the `react` organization. GitHub will automatically redirect all existing URLs, issues and PRs to the new location.
