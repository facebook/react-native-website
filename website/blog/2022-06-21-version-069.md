...
- [Highlights of 0.69](/blog/2022/06/21/version-069#highlights-of-068)
...
On React Native 0.69, React 18 is enabled by default. However, if you have not migrated to the New Architecture, you will only be able to leverage the features that don't use concurrent rendering and concurrent features. New Architecture has been built with concurrent rendering in mind but we cannot add that support for the old architecture.
...
- [Deprecating support](https://github.com/facebook/react-native/commit/5f2835b14d35681c268dd64d6ec284ea5f053be3) for iOS/tvOS SDK 11.0, 12.4+
...
- React Native CLI has [been bumped](https://github.com/facebook/react-native/commit/0605880c9ed0aec812f3198eb5075db64fba969a) to [v8.0.0](https://github.com/react-native-community/cli/releases/tag/v8.0.0)
