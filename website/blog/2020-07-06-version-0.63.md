...
These components make it easy to get started making things interactive. However, because they include built-in styles and effects that don’t match the platform interaction, users can tell when experiences are written with React Native.
