...
<video width="700" controls="controls" autoplay>
  <source type="video/mp4" src="https://facebook.github.io/react-native/img/homepage/ReactRefresh.mp4"></source>
</video>
</p>
...
- **Add useWindowDimensions Hook. **This new Hook automatically provides and subscribes to dimension updates, and can be used instead of the Dimensions API in most cases. See [x] for more information.
