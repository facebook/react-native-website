...
- [Handle taps on views outside parent bounds on Android](#handle-taps-on-child-views-outside-parent-boundaries-on-android)
- [New bluetooth permissions on Android](#new-android-bluetooth-permissions)
- [Better Support for Apple Silicon, Xcode 13, and iOS 15](#better-support-for-apple-silicon-xcode-13-and-ios-15)
- [Hermes 0.9.0](#hermes-090)
- [Nightly and “Commitly” Releases](#nightly-and-commitly-releases)
