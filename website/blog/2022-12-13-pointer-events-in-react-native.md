...
Today we are sharing a experimental cross-platform pointer API for React Native. We’ll go over motivations, how it works, and its benefits to React Native users. There are instructions on how to enable and we’re excited to hear your feedback!
...
Pointer Events are only implemented for the new architecture and are only available for React Native 0.71+ which at the time of writting is a release candidate.
