...
## Even more upgrading support

When 0.61 was released, the community introduced a new tool called [upgrade-helper](https://react-native-community.github.io/upgrade-helper/) to better support developers in their upgrading effort. It has been a great addition and we are grateful for all the positive vibes that we felt around that project.

That said, given that upgrading can still be an hard task because of the inevitable evolution of the native platforms, we have decided to one-up the dedicated upgrading resources: we are eager to announce [Upgrade-Support](https://github.com/react-native-community/upgrade-support), a central place to request and give help when upgrading your app.

Upgrade Support is a GitHub repo hosting an issue tracker where people can post any issues they have while upgrading their projects. This should help increase the likelihood that people can find others with the same problems and work together to figure out a solution. For more information around this project, please refer to its [README](https://github.com/react-native-community/upgrade-support).
