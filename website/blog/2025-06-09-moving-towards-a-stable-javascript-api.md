...
In 0.80, we're addressing these issues by deprecating deep imports, and a introducing user opt-in to a new, generated API baseline in TypeScript. We're calling this our **Strict TypeScript API**. Ultimately, this is the groundwork to offer a stable React Native API in future.
...
We're scoping our public API to the exports of React Native's `index.js` file, which we carefully maintain. This means that file changes elsewhere in our codebase will no longer be breaking changes.
...
These changes were made possible by [Alex Hunt](https://x.com/huntie), [Riccardo Cipolleschi](https://x.com/CipolleschiR), [Iwo Plaza](https://x.com/iwoplaza), [Jakub Piasecki](https://x.com/breskin67), and [Dawid Małecki](https://github.com/coado).

Thanks also to members of the React Native community that gave feedback on the [deep imports removal RFC](https://github.com/react-native-community/discussions-and-proposals/pull/894).
