...
You can see the native driver in action by running the [RNTester app](https://github.com/facebook/react-native/blob/0.64-stable/packages/rn-tester/), then loading the Native Animated Example. You can also take a look at the [source code](https://github.com/facebook/react-native/blob/0.64-stable/packages/rn-tester/js/examples/NativeAnimation/NativeAnimationsExample.js) to learn how these examples were produced.
...
- [AnimatedGratuitousApp](https://github.com/facebook/react-native/tree/0.64-stable/packages/rn-tester/js/examples/Animated/AnimatedGratuitousApp)
- [NativeAnimationsExample](https://github.com/facebook/react-native/blob/0.64-stable/packages/rn-tester/js/examples/NativeAnimation/NativeAnimationsExample.js)
...
This example uses a preset value, you can customize the animations as you need, see [LayoutAnimation.js](https://github.com/facebook/react-native/blob/0.64-stable/Libraries/LayoutAnimation/LayoutAnimation.js) for more information.
