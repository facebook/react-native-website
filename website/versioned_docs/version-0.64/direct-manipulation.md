...
[TouchableOpacity](https://github.com/facebook/react-native/blob/0.64-stable/Libraries/Components/Touchable/TouchableOpacity.js) uses `setNativeProps` internally to update the opacity of its child component:
