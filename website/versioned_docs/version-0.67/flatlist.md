...
See [`ViewabilityHelper.js`](https://github.com/facebook/react-native/blob/0.67-stable/Libraries/Lists/ViewabilityHelper.js) for flow type and further documentation.
