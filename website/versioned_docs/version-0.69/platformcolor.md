...
> **Note:** You can find a complete example that demonstrates proper, intended use of `PlatformColor` in [PlatformColorExample.js](https://github.com/facebook/react-native/blob/0.69-stable/packages/rn-tester/js/examples/PlatformColor/PlatformColorExample.js).
