...
If you have already installed Node on your system, make sure it is the current or previous LTS version of Node. If you already have a JDK on your system, make sure it is version 11 or newer.
