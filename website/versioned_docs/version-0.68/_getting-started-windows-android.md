...
It is recommended to use an [LTS version of Node](https://nodejs.org/en/about/releases/). If you want to be able to switch between different versions, you might want to install Node via [nvm-windows](https://github.com/coreybutler/nvm-windows), a Node version manager for Windows.
...
If you have already installed Node on your system, make sure it is the current or previous [LTS version of Node](https://nodejs.org/en/about/releases/). If you already have a JDK on your system, make sure it is version 11 or newer.
