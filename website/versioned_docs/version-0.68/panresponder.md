...
Try the [PanResponder example in RNTester](https://github.com/facebook/react-native/blob/0.68-stable/packages/rn-tester/js/examples/PanResponder/PanResponderExample.js).
