...
Assuming that you have [the current or previous LTS version of Node](https://nodejs.org/en/download/) or greater installed, you can use npm to install the Expo CLI command line utility:
