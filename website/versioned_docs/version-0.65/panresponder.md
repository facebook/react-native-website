...
Try the [PanResponder example in RNTester](https://github.com/facebook/react-native/blob/0.65-stable/packages/rn-tester/js/examples/PanResponder/PanResponderExample.js).
