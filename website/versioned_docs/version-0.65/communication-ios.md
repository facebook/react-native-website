...
You can checkout full source code of the example [here](https://github.com/facebook/react-native/blob/0.65-stable/packages/rn-tester/RNTester/NativeExampleViews/FlexibleSizeExampleView.m).
