...
```shell
npx @react-native-community/cli@latest init SampleApp --version 0.81.0
```
...
```sh
curl -O https://raw.githubusercontent.com/facebook/react-native/v0.81.0/packages/react-native/ReactAndroid/cmake-utils/default-app-setup/OnLoad.cpp
```
