...
<img loading="lazy" src="/docs/assets/d_security_chart.svg" width={283} alt=" " style={{float: 'right'}} />
...
<img loading="lazy" src="/docs/assets/d_security_deep-linking.svg" width={225} alt=" " style={{float: 'right', margin: '0 0 1em 1em'}} />
