...
The plugin is also used inside 3rd party libraries, to run the [Codegen](/docs/experimental/the-new-architecture/pillars-codegen) used for the New Architecture.
...
- Invoking the [React Native Codegen](/docs/experimental/the-new-architecture/pillars-codegen) if a library or app is using the Codegen for the New Architecture.
