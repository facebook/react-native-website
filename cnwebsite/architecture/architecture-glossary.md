...
_Yoga 树_ 被 [Yoga](https://yogalayout.com/) 使用来计算 React 影子树的布局信息。每个 React 影子节点通常创建一个 _Yoga 节点_，因为 React Native 使用 Yoga 来计算布局。然而，这不是硬性要求。Fabric 也可以创建不使用 Yoga 的 React 影子节点；每个 React 影子节点的实现决定了如何计算布局。
