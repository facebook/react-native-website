...
一个库的最新版本通常与最新版本的 React Native 兼容。如果你使用的是旧版本，你应当查阅 README 文件了解应该安装该库的哪个版本。你可以通过运行 `npm install <library-name>@<version-number>` 命令来安装特定版本的库，例如：`npm install @react-native-community/netinfo@^2.0.0`。
