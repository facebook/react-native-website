...
First, ensure you're using at least version 0.60.1 of React Native. If you're upgrading an existing app ensure everything works before trying to switch to Hermes.
