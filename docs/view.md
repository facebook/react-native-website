...
Indicates whether this `View` should render itself (and all of its children) into a single hardware texture on the GPU.
...
Indicates whether this `View` should be rendered as a bitmap before compositing.
