...
It is recommended that you use an abstraction on top of `AsyncStorage` instead of `LocalStorage` directly for anything more than light usage since it operates globally.
