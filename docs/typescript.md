...
New projects created by the [React Native CLI](/docs/get-started-without-a-framework#step-1-creating-a-new-application) or popular templates like [Ignite][ignite] will use TypeScript by default.
