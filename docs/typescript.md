...
New projects created by the [React Native CLI](/docs/set-up-your-environment?os=macos&platform=ios#creating-a-new-application) or popular templates like [Ignite][ignite] will use TypeScript by default.
