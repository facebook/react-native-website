...
> On Android, as of API Level 28, clear text traffic is also blocked by default. This can be overriden by setting [`android:usesCleartextTraffic`](https://developer.android.com/guide/topics/manifest/application-element#usesCleartextTraffic) in the app manifest file.
