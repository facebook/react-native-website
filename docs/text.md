...
You also lose the ability to set up a default font for an entire subtree. Meanwhile, `fontFamily` can only accept exact **one** font name, which is totally different form `css font-family`. The recommended way to use consistent fonts and sizes across your application is to create a component `MyAppText` that includes them and use this component across your app. You can also use this component to make more specific components like `MyAppHeaderText` for other kinds of text.
