...
```kotlin title="RTNCenteredText/android/src/main/java/com/rtncenteredtext/CenteredTextManager.kt
package com.rtncenteredtext
    ...
    return new ReactModuleInfoProvider() {
      ...
      public Map<String, ReactModuleInfo> get() {
        ...
        map.put(CenteredTextManager.REACT_CLASS, new ReactModuleInfo(
                CenteredTextManager.REACT_CLASS,
                CenteredTextManager.REACT_CLASS,
                false,
                false,
                false,
...
```kotlin title="RTNCenteredText/android/src/main/java/com/rtncenteredtext/CenteredTextPackage.kt
package com.rtncenteredtext
