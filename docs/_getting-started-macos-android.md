...
The Zulu OpenJDK distribution offers JDKs for **both Intel and M1 Macs**. This will make sure your builds faster on M1 Macs compared to using an Intel-based JDK.
