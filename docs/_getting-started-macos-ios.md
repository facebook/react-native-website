...
If you are using Xcode version 14.0 or greater than to install a simulator, open <strong>Xcode > Settin > Platforms</strong> tab. Click + icon to add more simulator. 
