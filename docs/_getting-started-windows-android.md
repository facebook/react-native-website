...
If you have already installed Node on your system, make sure it is Node 18.20 or newer. If you already have a JDK on your system, we recommend JDK17. You may encounter problems using higher JDK versions.
