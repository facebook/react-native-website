...
> This document refers to the architecture of [Fabric, the new renderer](fabric-renderer) that is in active roll-out.
...
3. [Fabric State Updates](#fabric-state-updates)
