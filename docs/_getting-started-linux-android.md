...
Follow the [installation instructions for your Linux distribution](https://nodejs.org/en/download/package-manager/) to install the current or previous [LTS version of Node](https://nodejs.org/en/about/releases/).
