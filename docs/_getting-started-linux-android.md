...
To do that, open Android Studio, and on the welcome screen :
- click on "Configure" button and select "SDK Manager"
- or be sure to select "Projects" on the left sidebar, and click on "More Actions" → "SDK Manager"

If you have already opened a project with Android Studio, the SDK Manager can be found in: "Files" → "Settings"

Then, you will see a new window "Settings":
- Select **Appearance & Behavior** → **System Settings** → **Android SDK**
- Select the "SDK Platforms" tab from within the SDK Manager, then check the box next to "Show Package Details" in the bottom right corner. Look for and expand the `Android 13 (Tiramisu)` entry, then make sure the following items are checked:
  - `Android SDK Platform 33`
  - `Intel x86 Atom_64 System Image` or `Google APIs Intel x86 Atom System Image` or `Google APIs Intel x86_64 Atom System Image`
